...
constants.environment.CLOUD_API_BASE_URL = process.env.CONTAINERSHIP_CLOUD_API_BASE_URL || "http://stage-k8s-api.containership.io" || constants.environment.DEFAULT_CLOUD_API_BASE_URL;
